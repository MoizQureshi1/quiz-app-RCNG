...
questions = [
    ...
    {
        "question": "The famous Badshahi Mosque is located in which city of Pakistan?",
        "options": ["Lahore", "Islamabad", "Faisalabad", "Karachi"],
        "answer": "Lahore",
    },
    {
        "question": "Which of the following is the largest province of Pakistan by area?",
        "options": ["Punjab", "Khyber Pakhtunkhwa", "Sindh", "Balochistan"],
        "answer": "Punjab",
    },
    {
        "question": " Who was the first President of Pakistan?",
        "options": [ "Liaquat Ali Khan", "Iskander Mirza", "Zulfikar Ali Bhutto", "Ayub Khan"],
